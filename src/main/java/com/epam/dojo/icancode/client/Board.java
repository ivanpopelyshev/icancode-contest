...
public class Board extends AbstractBoard<Elements> {
    ...
    public boolean isBarrierAt(int x, int y) {
        return !isAt(LAYER2, x, y, EMPTY, GOLD,
    ...
    public boolean isWall(Elements e) {
        return e == ANGLE_IN_LEFT ||
                e == WALL_FRONT ||
                e == ANGLE_IN_RIGHT ||
                e == WALL_RIGHT ||
                e == ANGLE_BACK_RIGHT ||
                ...
                e == ANGLE_BACK_LEFT ||
                e == WALL_LEFT ||
                e == WALL_BACK_ANGLE_LEFT ||
                e == WALL_BACK_ANGLE_RIGHT ||
                e == ANGLE_OUT_RIGHT ||
                e == ANGLE_OUT_LEFT ||
                ...
                e == LASER_MACHINE_READY_DOWN;
    }

    public boolean isWallOrWhole(Elements e) {
        return isWall(e) || e == HOLE;
    }

    public boolean isGoodAt(int x, int y) {
        Elements e1 = getAt(LAYER1, x, y);
        Elements e2 = getAt(LAYER2, x, y);
        return !isWall(e1) && e1 != HOLE && e1 != ROBO_FALLING && e1 != ROBO_OTHER_FALLING &&
                e2 != BOX && e2 != ROBO_OTHER_FLYING_ON_BOX && e2 != ROBO_FLYING_ON_BOX;
    }

    public boolean isWallAt(int x, int y) {
        if (x < 0 || y < 0 || x >= size || y >= size) return true;
        return isWall(getAt(LAYER1, x, y));
    }
    ...
    private DeikstraFindWay.Possible possible() {
        return new DeikstraFindWay.Possible() {
            ...
            public boolean possible(Point from, Direction where) {
                ...
                if (isHoleAt(nx, ny)) return false;
